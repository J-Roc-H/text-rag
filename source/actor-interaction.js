...
function aiInstallStyle(){
  ...
  st.textContent=`
    ...
    .ai-scene-icon{width:29px;flex:0 0 29px;text-align:center;font-size:21px}.ai-scene-main{min-width:0;flex:1}.ai-scene-name{font-size:12px;font-weight:750;display:flex;gap:5px;align-items:center}.ai-scene-summary{display:block;font-size:10px;color:var(--text-dim);margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ai-badge{font-size:11px;flex:0 0 auto}
